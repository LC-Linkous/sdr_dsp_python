...
expectations about what the demods can do and where this has been actively tested.
...
*development* platform (it covers the whole spectrum and forces honest DSP for development)
 but it's not the best *reception* platform for demanding modulations.
